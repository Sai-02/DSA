...
class ThroneInheritance {
    ...
    public ThroneInheritance(String kingName) {
        ...
        hm = new HashMap<>();
        hm.put(kingName, new ArrayList<String>());
        dead = new HashSet<>();
    }

    public void birth(String parentName, String childName) {
        hm.get(parentName).add(childName);
        hm.put(childName, new ArrayList<String>());
    }
    ...
    private void dfs(String parentName, List<String> ans) {
        if (!dead.contains(parentName))
            ans.add(parentName);
        for (String child : hm.get(parentName)) {
            dfs(child, ans);
        }
    }
}
