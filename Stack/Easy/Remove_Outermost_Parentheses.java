 ...
 * "()()" + "()" + "()(())" = "()()()()(())". Example 3:
 * 
 * Input: s = "()()" Output: "" Explanation: The input string is "()()", with
 ...
 * Constraints:
 * 
 * 1 <= s.length <= 105 s[i] is either '(' or ')'. s is a valid parentheses
 * string. Accepted 153,658 Submissions 193,193 Seen this question in a real
 * interview before?
 * 
 * Yes
 * 
