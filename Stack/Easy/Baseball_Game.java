 ...
 * record, record is now [5, 10, 15]. The total sum is 5 + 10 + 15 = 30. Example
 * 2:
 * 
 ...
 * Constraints:
 * 
 * 1 <= ops.length <= 1000 ops[i] is "C", "D", "+", or a string representing an
 * integer in the range [-3 * 104, 3 * 104]. For operation "+", there will
 * always be at least two previous scores on the record. For operations "C" and
 * "D", there will always be at least one previous score on the record. Accepted
 * 130,796 Submissions 190,367 Seen this question in a real interview before?
 * 
 * Yes
 * 
 * No
