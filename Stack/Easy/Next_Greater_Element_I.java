 ...
 * Constraints:
 * 
 * 1 <= nums1.length <= nums2.length <= 1000 0 <= nums1[i], nums2[i] <= 104 All
 * integers in nums1 and nums2 are unique. All the integers of nums1 also appear
 * in nums2.
 * 
 * 
 * Follow up: Could you find an O(nums1.length + nums2.length) solution?
 * Accepted 289,025 Submissions 420,686
 */
import java.util.*;
